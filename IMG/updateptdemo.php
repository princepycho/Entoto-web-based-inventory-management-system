...
// Make quick references to our fields
	...
	var kebele = document.getElementById('txtkebele');
	var houseno = document.getElementById('txthouseno');
	var ward = document.getElementById('txtward');
	var dateofreg = document.getElementById('datepicker1');
          ...
          <table width="100%" border=0>
            <tr>
              <td height="22"><table width="100%" border=0>
                  ...
                  <tr>
                    <td width="245" height="37"><div align="right"><strong><font color="#FF0000">*</font>Card Number : </strong></div></td>
                    <td width="128"><input type="textbox" name="txtcardno" id="txtcardno" maxlength="10"  value="<?php echo $cardno?>" style="width:176px;" READONLY></td>
                  </tr>
				  <tr>
